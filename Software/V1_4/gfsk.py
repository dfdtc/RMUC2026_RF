...
class gfsk(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "gfsk", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("gfsk")
        ...
        self.digital_gfsk_demod_0 = digital.gfsk_demod(
            ...
            verbose=False,
            log=False)
        self.blocks_vector_source_x_0 = blocks.vector_source_b((82,77,50,48,50,54), True, 1, [])
        self.blocks_throttle2_0 = blocks.throttle( gr.sizeof_char*1, samp_rate, True, 0 if "auto" == "auto" else max( int(float(0.1) * samp_rate) if "auto" == "time" else int(0.1), 1) )
        self.blocks_stream_to_tagged_stream_0 = blocks.stream_to_tagged_stream(gr.sizeof_char, 1, 6, "packet_len")
        ...
        self.connect((self.digital_map_bb_0, 0), (self.blocks_throttle2_0, 0))
